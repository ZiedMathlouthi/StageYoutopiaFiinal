...
!(function () {
      ...
      K =
        a.found && n.found
          ? ((k = (w = V).children),
            ...
            (z = O.width),
            (E = O.icon),
            (j = Mt({ transform: P, containerWidth: z, iconWidth: N })),
            (L = { tag: "rect", attributes: Q({}, zt, { fill: "white" }) }),
            (R = M.children ? { children: M.children.map(Et) } : {}),
            (I = {
              tag: "g",
              attributes: Q({}, j.inner),
              children: [
                Et(
                  Q({ tag: M.tag, attributes: Q({}, M.attributes, j.path) }, R)
                ),
              ],
            }),
            (_ = { tag: "g", attributes: Q({}, j.outer), children: [I] }),
            (T = "mask-".concat(S || kt())),
            (Y = "clip-".concat(S || kt())),
            (F = {
              tag: "mask",
  ...
  function Jt(t) {
    return t.reduce(function (t, e) {
      ...
      if (Kt[e]) t.prefix = e;
        ...
        e !== $.replacementClass && 0 !== e.indexOf("fa-w-") && t.rest.push(e);
      return t;
    }, Gt());
  }
  function Qt(t, e, n) {
  ...
  var ee = {
    replace: function (t) {
      ...
      if (e.parentNode && e.outerHTML)
        e.outerHTML =
          n +
          ($.keepOriginalSource && "svg" !== e.tagName.toLowerCase()
    ...
    nest: function (t) {
      ...
      n[0].attributes.className = r.toSvg.join(" ");
      var i = n
        .map(function (t) {
          return Zt(t);
        })
  ...
  function ae(n, t) {
    ...
    if (0 === n.length) a();
      ...
      var e = ne;
      $.mutateApproach === P && (e = g.requestAnimationFrame || ne),
        e(function () {
          var t =
              !0 === $.autoReplaceSvg
                ? ee.replace
                : ee[$.autoReplaceSvg] || ee.replace,
            e = Yt.begin("mutate");
          n.map(t), e(), a();
        });
    }
          ...
          At(t).forEach(function (t) {
            if (
              ("childList" === t.type &&
                ...
                !te(t.addedNodes[0]) &&
                ($.searchPseudoElements && o(t.target), r(t.target)),
              "attributes" === t.type &&
                t.target.parentNode &&
  ...
  var de = { fill: "currentColor" },
    ...
    ge = {
      ...
      children: [
        ...
        {
          tag: "circle",
          attributes: Q({}, de, { cx: "256", cy: "364", r: "28" }),
          children: [
            {
              tag: "animate",
              attributes: Q({}, me, {
            ...
            {
              tag: "animate",
              attributes: Q({}, he, { values: "1;0;1;1;0;1;" }),
            },
          ],
        },
        {
          ...
          children: [
            {
              tag: "animate",
              attributes: Q({}, he, { values: "1;0;0;0;0;1;" }),
            },
          ],
        },
        {
          ...
          children: [
            {
              tag: "animate",
              attributes: Q({}, he, { values: "0;0;1;1;0;0;" }),
            },
          ],
        },
      ],
  ...
  function xe(t) {
    ...
    return ~a.extra.classes.indexOf(j)
      ? (function (t, e) {
          ...
          return (
            $.autoA11y && !n && (r.attributes["aria-hidden"] = "true"),
            vt.resolve([
              t,
              Lt({
                content: t.innerHTML,
  ...
  function Ce(m, p) {
    ...
    return new vt(function (a, t) {
      ...
      if (r && "none" !== o && "" !== o) {
        var c = ~["Solid", "Regular", "Light", "Duotone", "Brands"].indexOf(
            r[1]
          )
            ? E[r[1].toLowerCase()]
            : R[i],
  ...
  var Le,
      ...
      ((Le = function (t) {
        ...
        if (t) {
          var w = t.prefix,
            x = t.iconName,
            k = t.icon;
          return Ee(Q({ type: "icon" }, t), function () {
            return (
              ze(),
              $.autoA11y &&
                (u
          ...
          return (
            ...
            Lt({
              ...
              extra: {
                attributes: l,
                styles: u,
                classes: ["".concat($.familyPrefix, "-layers-text")].concat(
                  d(c)
                ),
              },
            })
          ...
          return (
            ...
            (function (t) {
              ...
              extra: {
                attributes: c,
                styles: l,
                classes: ["".concat($.familyPrefix, "-layers-counter")].concat(
                  d(i)
                ),
              },
            })
    ...
    Fe = function () {
      var t = (
        ...
        e = void 0 === t ? v : t;
      (0 < Object.keys(W.styles).length || $.autoFetchSvg) &&
        m &&
        $.autoReplaceSvg &&
        Ye.dom.i2svg({ node: e });
    };
