                    ...
                    <Form method="post" id="registration">
                      ...
                      >
                        <Nav.Link
                          ...
                          href="#user-detail"
                        >
                          <i className="material-symbols-outlined bg-soft-primary text-primary">
                            lock_open
                          </i>
                        ...
                        >
                          <i className="material-symbols-outlined bg-soft-danger text-danger">
                            person
                          </i>
                        ...
                        <Nav.Link
                          ...
                          href="#bank-detail"
                        >
                          <i className="material-symbols-outlined bg-soft-success text-success">
                            photo_camera
                          </i>
                        ...
                        <Nav.Link
                          ...
                          href="#cpnfirm-data"
                        >
                          <i className="material-symbols-outlined bg-soft-warning text-warning">
                            done
                          </i>
                          <span>Confirm</span>
                        </Nav.Link>
